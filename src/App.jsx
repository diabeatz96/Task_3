...
function App() {
  ...
  return (
    <main className="flex flex-col w-screen h-screen bg-zinc-800 overflow-y-auto">
      ...
      <div className= "grid md:grid-cols-3 space-y-6 place-items-center place-self-center bg-zinc-800">
          <div >
            <FilterProducts/>
          </div>
          <div>
